...
class Brick{
    ...
    func bricks() -> Bricks{
        ...
        bricks.append(Bricks(color: .magenta, points: brick1, brickName: "brick1"))
        ...
        brick7.append(CGPoint(x: -2, y: 1))
        bricks.append(Bricks(color: .systemMint, points: brick7, brickName: "brick7"))
